...
if __name__ == '__main__':
    ...
    plt.plot(vsy_vals, Fy_vals, label=r"$F_y$")
    ...
    plt.gca().set_xlabel(r"$v_y$ [m/s]")
    plt.gca().set_ylabel(r"$F$ [N]")
    # plt.gca().set_title(r"$v_x=1.1$ $v_r=1$")
    plt.legend()

    plt.savefig("../doc/fy_of_vy.png")
    plt.savefig("/home/sven/ma-mpc/tex/images/rwpacejka.pdf", bbox_inches="tight")
    plt.show()
