...
if __name__ == '__main__':
    ...
    vr_vals = np.linspace(1.0, 1.2, num=4)
    for vr_val in vr_vals:
        ...
        for vsy_val in vsy_vals:
            Fx_val, Fy_val = calc_forces(vr_val, 1, vsy_val, p_val)
    ...
    plt.savefig("/home/sven/ma-mpc/tex/images/fy_varying_vr.pdf", bbox_inches="tight")
    plt.show()
